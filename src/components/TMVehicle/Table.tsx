...
const initialRows = [
  ...
  createData(2, "Driver charged with speeding in garment truck", new Date('2021-04-08'), "Driver Suspended"),
  createData(3, "Cited for speeding", new Date('2021-04-10'),"Driver Suspended"),
  createData(4, "Driver charged with speeding in garment truck", new Date('2020-10-08'), "Driver Suspended"),
  createData(5, "Cited for speeding", new Date('2021-06-18'), "Driver Suspended"),
];
